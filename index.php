...
<body>
	...
	<section id="banner" class="gamearena">
		<div id="banner_content_wrapper">
			<div id="poster">
				<img src="images/Banners/1st.jpg" alt="Kart game" class="featured_image">
				
				<img src="images/play_button.png" alt="Play Trailer" class="play_button">
			</div>
			<div id="content">
				<h2 class="title">Kart Racers</h2>
				<div class="ratings">
				...
				<p class="description">Nickelodeon Kart Racers : Grand Prix is a racing video game developed by Bamtang Games and published by GameMill Entertainment in North America, Maximum Games in Europe, and Ripples Asia Venture in Japan.</p>

				<p class="info">13+ <span>|</span> New <span>|</span> Action, Adventure<span>|</span> 5 May 2022</p>
			</div>
		</div>
	</section>
...
<script>
	...
	<section id="games-barfirst" class="gamearena">
		<div class="wrapper">
			...
			<header class="gamearena">
				...
				<h2>Popular Games</h2> <i class='fa fa-fire' style='font-size:24px'></i>
			...
			<div class="row">
				<div class="post">
					<img src="images/Img/Popular/1.jpg" alt="The Martian">
					<h3 class="title">Ratchet Clank</h3>
					<p class="post_info">13+</p>
				</div>
			
				<div class="post">
					<img src="images/Img/Popular/2.jpg" alt="Inside Out">
					<h3 class="title">On a Roll</h3>
					<p class="post_info">13+</p>
				</div>
			
				<div class="post">
					<img src="images/Img/Popular/3.jpg" alt="Jurassic World">
					<h3 class="title">Mighty Pups</h3>
					<p class="post_info">14+</p>
				</div>
			
				<div class="post">
					<img src="images/Img/Popular/4.jpg" alt="Mad Max">
					<h3 class="title">The Incredibles</h3>
					<p class="post_info">14+</p>
				</div>
			
				<div class="post">
					<img src="images/Img/Popular/5.jpg" alt="Star Wars">
					<h3 class="title">Rainy Brains</h3>
					<p class="post_info">14+</p>
				</div>
			
				<div class="post">
					<img src="images/Img/Popular/6.jpg" alt="The Avengers">
					<h3 class="title">Super Heros</h3>
					<p class="post_info">15+</p>
				</div>
			</div>
	...
	<section id="games-barsecond" class="gamearena">
		<div class="wrapper">
			<header class="gamearena">
				<h2>Mathamatics Games</h2>
				<a href="#"><p class="view_more">View All Games</p></a>
			</header>

			<div class="row">
				<div class="post">
					<img src="images/Img/New/7.jpg" alt="The Walking Dead">
					<h3 class="title">Sonic Forces</h3>
					<p class="post_info">11+</p>
				</div>
			
				<div class="post">
					<img src="images/Img/New/8.jpg" alt="Game Of Thrones">
					<h3 class="title">Spyro</h3>
					<p class="post_info">11+</p>
				</div>
			
				<div class="post">
					<img src="images/Img/New/9.jpg" alt="Breaking Bad">
					<h3 class="title">Jungle Book</h3>
					<p class="post_info">11+</p>
				</div>
			
				<div class="post">
					<img src="images/Img/New/10.jpg" alt="Empire">
					<h3 class="title">Overcooked</h3>
					<p class="post_info">13+</p>
				</div>
			
				<div class="post">
					<img src="images/Img/New/11.jpg" alt="Master of None">
					<h3 class="title">Nitro Fueled</h3>
					<p class="post_info">12+</p>
				</div>
			
				<div class="post">
					<img src="images/Img/New/12.jpg" alt="Mr Robot">
					<h3 class="title">Family Funpack</h3>
					<p class="post_info">13+</p>
				</div>
			</div>
